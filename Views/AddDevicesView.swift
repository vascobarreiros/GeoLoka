                ...
                VStack {
                    ...
                    Section {
                        Button(action: {
                            ...
                            // TBD
                            let urlString2 = "https://lokagetlocations-uyiltasaia-ew.a.run.app/get_device_by_deviceid.php?identifier=\(UserDefaults.standard.string(forKey: signInWithAppleMager.userIdentifierKey)!)&device_id=\(device_id)"
                                        ...
                                        if let safeData = data{
                                            do{
                                                ...
                                                DispatchQueue.main.async {
                                                    print("Numero de resultados é de (se for diferente de zero é porque é duplicado) = \(results.count)")
                                                    if results.count == 1 {
                                                        existe = true
                                                        self.showAlert = true
                    ...
                    .alert(isPresented: $showAlert) {
                        ...
                        case .third:
                            return Alert(title: Text(NSLocalizedString("Device NOT added",comment: "")), message: Text("The device \(device_id) its duplicated - Please check again"), dismissButton: .default(Text("Ok")))
                        }
                    }
