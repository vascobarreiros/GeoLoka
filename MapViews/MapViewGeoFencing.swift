   ...
   // var shared_Geo : GettingGeoFencingMap
    ...
    func updateUIView(_ uiView: MKMapView, context: Context) {
     ...
     //   shared_Geo.doneGettingGeoFencingMap = true
        let url = URL(string: "https://lokagetlocations-uyiltasaia-ew.a.run.app/get_geofencing.php?identifier=\((UserDefaults.standard.string(forKey: signInWithAppleMager.userIdentifierKey)!))")!
